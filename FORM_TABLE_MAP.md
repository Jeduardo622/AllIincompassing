...
| `/clients/new` | `src/pages/ClientOnboardingPage.tsx`, `src/components/ClientOnboarding.tsx` | `clients` (email uniqueness check) | `clients` | Storage: `client-documents` bucket | Uploads documents and stores metadata on client row. |
...
| `/authorizations` | `src/pages/Authorizations.tsx`, `src/components/AuthorizationModal.tsx` | `authorizations`, `authorization_services`, `clients`, `therapists` | `authorizations`, `authorization_services` | - | CRUD for authorizations and services. |
