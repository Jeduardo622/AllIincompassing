...
- **Booking update-session closure (working now)** - Current status and evidence for the `Edit Session -> Update Session` incident are documented in [docs/THERAPIST_SESSIONS_WORKFLOW.md](docs/THERAPIST_SESSIONS_WORKFLOW.md#2026-04-booking-update-session-incident-closure).
