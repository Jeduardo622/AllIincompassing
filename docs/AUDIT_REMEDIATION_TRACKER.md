...
- **2026-04-17 post-apply (WIN-35 throughput wave):** `20260417100000_unused_index_drop_throughput_alpha_win35.sql`, `20260417110000_unused_index_drop_throughput_beta_win35.sql`, `20260417120000_unused_index_drop_throughput_gamma_win35.sql` applied on hosted; MCP counts `unused_index` **152**, `multiple_permissive_policies` **107** — see [docs/supabase/win-35-throughput-wave-20260417.md](supabase/win-35-throughput-wave-20260417.md) and `docs/supabase/advisors-2026-04-17-win35-throughput-post.json`.
...
## Documentation change log (2026-04-17, WIN-35 throughput wave)
- **WIN-35:** Merged **PR #431** then shipped three disjoint unused-index migrations (15 drops) with pre/post MCP JSON under `docs/supabase/advisors-2026-04-17-win35-throughput-*.json` and wave note `docs/supabase/win-35-throughput-wave-20260417.md`. Verification: governance, `ci:check-focused`, `lint`, `typecheck`, `test:ci`, `build`, `validate:tenant`. Follow-up PR opened for repo/ledger alignment (see wave note PR link).
