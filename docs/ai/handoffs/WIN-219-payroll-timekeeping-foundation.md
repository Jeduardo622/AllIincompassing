...
- result: `pass-with-blocked-checks`
- residual risk: exact-head hosted CI must confirm the checked-in workflow heap and credentialed browser smoke; independent human critical-lane review, payroll/legal review, a separate explicit owner activation action, and a post-activation parity-promotion PR remain mandatory
