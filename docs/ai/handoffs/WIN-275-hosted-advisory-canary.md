...
Recovery authorization is also separate and requires `I_ATTEST_SOLO_MAINTAINER_CRITICAL_REVIEW_AND_APPROVE_WIN_275_PG_CRON_RESIDUE_RECOVERY` plus immutable `expected_pg_cron_oid=457927`.
