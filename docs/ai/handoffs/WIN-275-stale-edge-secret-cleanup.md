...
- Codex may perform exactly one browser click dispatch only for a path in the exact three-entry allowlist, with separate explicit current-task owner authorization per workflow
