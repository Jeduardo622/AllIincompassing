...
- remaining for this fix: run the complete final-head gate matrix, create the focused commit through normal hooks, execute two fresh Phase 2 runs from that commit, update PR `#894` and `WIN-275`, and obtain submitted human protected-path/Supabase/security review before merge
