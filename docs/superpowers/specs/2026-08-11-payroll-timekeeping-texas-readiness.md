...
- Texas guidance ties the ordinary nonexempt population to the federal FLSA hours-worked and overtime framework.
...
- Texas guidance does not impose a California-style state meal/rest timing or premium rule for the ordinary adult population in the reviewed sources.
...
- A monthly pay group must be rejected for the ordinary Texas nonexempt employee population because the TWC rule still requires at least twice-monthly pay on regularly scheduled paydays.
...
- Texas unemployment-tax guidance makes a four-year payroll-record retention period the conservative baseline.
