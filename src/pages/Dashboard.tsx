...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  const authorizedUnitsValue = isClientMetricsRedacted
    ? '—'
    : displayData.clientMetrics.totalUnits.toLocaleString('en-US');
        ...
        >
          <div className="p-6">
            ...
            <div className="rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className="font-medium text-blue-900 dark:text-blue-100">Total Authorized Units</h3>
                  <p className="mt-1 text-sm text-blue-800 dark:text-blue-200">
                    Combined 1:1, supervision, and parent consult units
                  </p>
                </div>
                <span className="text-xl font-bold text-blue-600 dark:text-blue-400">
                  {authorizedUnitsValue}
                </span>
              </div>
            </div>
          </div>
