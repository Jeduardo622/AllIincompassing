...
const actionCases = [
  ...
  },
  {
    ...
    payload: { action: "grant_capability", userId: "44444444-4444-4444-4444-444444444444", capability: "payroll.configure_settings", effectiveFrom: "2026-08-01T00:00:00Z", effectiveThrough: null },
  ...
  },
  {
    ...
    payload: { action: "revoke_capability", userId: "44444444-4444-4444-4444-444444444444", capability: "payroll.configure_settings", effectiveThrough: "2026-08-31T23:59:59Z" },
...
describe("payrollAdministrationHandler", () => {
  ...
  it("fails closed when a non-export reader receives latest export compensation totals", async () => {
    vi.mocked(getApiAuthorityMode).mockReturnValue("legacy");
    vi.mocked(fetchJson).mockResolvedValue({
      ok: true,
      status: 200,
      data: {
        ...
        payPeriods: [{
          ...
          latestExport: {
            ...
            totalGrossEarningsCents: 876543210,
