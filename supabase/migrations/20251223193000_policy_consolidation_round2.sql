/*
  # Policy consolidation round 2

  Focus: sessions, client_session_notes, ai_session_notes, session_note_templates,
  therapist_certifications, therapist_availability, client_guardians.

  Goal: single org-aware read/write pair per authenticated role set using
  app.user_has_role_for_org(...), keep service_role full access where needed.
*/
