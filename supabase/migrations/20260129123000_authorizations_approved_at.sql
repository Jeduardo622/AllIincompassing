/*
  # Add approved_at to authorizations

  1. Changes
    - Add approved_at timestamp to authorizations
    - Populate approved_at in create/update authorization RPCs when status becomes approved
*/
...
BEGIN
  ...
  SET
    ...
    approved_at = CASE
      WHEN lower(v_status) = 'approved' THEN coalesce(v_existing.approved_at, now())
