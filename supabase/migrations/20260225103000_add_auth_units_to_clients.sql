...
ALTER TABLE public.clients
  ADD COLUMN IF NOT EXISTS auth_units numeric DEFAULT 0;

COMMENT ON COLUMN public.clients.auth_units IS
  'Authorized auth service units';
...
BEGIN
  ...
  -- Normalize legacy status values and reject unsupported ones before insert.
