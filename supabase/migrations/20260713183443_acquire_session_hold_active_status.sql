-- @migration-intent: Reject session holds for inactive therapists or clients at the privileged database boundary.
-- @migration-dependencies: 20260713180735_acquire_session_hold_bcba_authorization.sql
-- @migration-rollback: Reapply the seven-argument acquire_session_hold definition without the therapist and client status predicates.
