-- @migration-intent: payroll_session_lifecycle_context_disabled_state
-- @migration-dependencies: 20260812103000_payroll_session_lifecycle_context.sql
-- @migration-rollback: Restore the prior public.get_session_payroll_context(uuid) body from 20260812103000_payroll_session_lifecycle_context.sql, preserve grants, then reload the PostgREST schema.
